        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="main-menu">
                <ul class="navbar-nav mr-auto w-100 justify-content-end">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="/eventos" data-toggle="dropdown" aria-haspopup="true"
                    ...
                    @if (Route::has('login'))
                        @auth
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link active dropdown-toggle" href="{{ route('logout') }}""
                                data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">olá {{ Auth::user()->name }}</a>
                                <div class="dropdown-menu">
                                    <a href="{{ route('home') }}">
                                        Home
                                    </a>
                            ...
                            @else
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                                       aria-expanded="false">Registar</a>
                                    <div class="dropdown-menu">
                            ...
                            <div class="blog-item-text">
                                ...
                                <div class="blog-one-footer">
                                    ...
                                    <form method="post" action="">
                                        ...
                                        {{--<button type="submit" class=""><i class="icon-heart"></i>{{4 }} Likes</button>--}}
                                        <a href="#" type="submit"><i class="icon-heart"></i> 59 Likes</a>
                                    </form>
        ...
        <div class="row section">
            ...
            <div class="footer-widget col-md-4 col-xs-12 wow fadeIn" data-wow-delay=".5s">
                ...
                <div class="plain-flicker-gallery">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14348.154694117433!2d32.56303131580354!3d-25.966771980171107!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xa3433553a713d269!2sMuseu+da+Moeda!5e0!3m2!1spt-PT!2smz!4v1508504507925"
