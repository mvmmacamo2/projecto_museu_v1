...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="/fame-template/asset/css/bootstrap.min.css" rel="stylesheet">
    <!-- <link rel="stylesheet" type="text/css" href="/bootstrap-4.0.0-beta/css/bootstrap.min.css"> -->
    
    <!-- Font Awesome CSS -->
    <link href="/fame-template/css/font-awesome.min.css" rel="stylesheet">
    
    
    <!-- Animate CSS -->
    <link href="/fame-template/css/animate.css" rel="stylesheet" >
    
    <!-- Owl-Carousel -->
    <link rel="stylesheet" href="/fame-template/css/owl.carousel.css" >
    ...
    <link href="/fame-template/css/responsive.css" rel="stylesheet">
    
    <!-- Colors CSS -->
    <link rel="stylesheet" type="text/css" href="/fame-template/css/color/green.css">
    
    
    
    <!-- Colors CSS -->
    <link rel="stylesheet" type="text/css" href="/fame-template/css/color/green.css" title="green">
    <link rel="stylesheet" type="text/css" href="/fame-template/css/color/light-red.css" title="light-red">
    <link rel="stylesheet" type="text/css" href="/fame-template/css/color/blue.css" title="blue">
    <link rel="stylesheet" type="text/css" href="/fame-template/css/color/light-blue.css" title="light-blue">
    <link rel="stylesheet" type="text/css" href="/fame-template/css/color/yellow.css" title="yellow">
    <link rel="stylesheet" type="text/css" href="/fame-template/css/color/light-green.css" title="light-green">
    ...
    <!-- Modernizer js -->
    <script src="/fame-template/js/modernizr.custom.js"></script>
...
================================================== -->
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="nav-item dropdown">
		                ...
		                <div class="dropdown-menu">
			                <a class="dropdown-item" href="/historias/museu">Museu Da Nacional Da Moeda</a>
                    ...
                    <li>
                        <a class="page-scroll" href="#about-us">Eventos</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="#service">Exposição</a>
                    </li>
                    <li>
        ...
        <div id="main-slide" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <img class="img-responsive" src="/fame-template/images/header-bg-1.jpg" alt="slider">
                ...
                <div class="item">
                    <img class="img-responsive" src="/fame-template/images/header-back.png" alt="slider">
                ...
                <div class="item">
                    <img class="img-responsive" src="/fame-template/images//galaxy.jpg" alt="slider">
                    <div class="slider-content">
                        <div class="col-md-12 text-center">
                            <h1 class="animated2">
                        ...
                        <ul id="portfolio-list">
                            <li>
                                <div class="portfolio-item">
                                    <img src="/fame-template/images/portfolio/img1.jpg" class="img-responsive" alt="" />
                            ...
                            <li>
                                <div class="portfolio-item">
                                    <img src="/fame-template/images/portfolio/img2.jpg" class="img-responsive" alt="" />
                                    <div class="portfolio-caption">
                                        <h4>Portfolio Title</h4>
                                        <a href="#portfolio-modal" data-toggle="modal" class="link-1"><i class="fa fa-magic"></i></a>
                                        <a href="#" class="link-2"><i class="fa fa-link"></i></a>
                            ...
                            <li>
                                <div class="portfolio-item">
                                    <img src="/fame-template/images/portfolio/img3.jpg" class="img-responsive" alt="" />
                                    <div class="portfolio-caption">
                                        <h4>Portfolio Title</h4>
                                        <a href="#portfolio-modal" data-toggle="modal" class="link-1"><i class="fa fa-magic"></i></a>
                                        <a href="#" class="link-2"><i class="fa fa-link"></i></a>
                            ...
                            <li>
                                <div class="portfolio-item">
                                    <img src="/fame-template/images/portfolio/img4.jpg" class="img-responsive" alt="" />
                                    <div class="portfolio-caption">
                                        <h4>Portfolio Title</h4>
                                        <a href="#portfolio-modal" data-toggle="modal" class="link-1"><i class="fa fa-magic"></i></a>
                                        <a href="#" class="link-2"><i class="fa fa-link"></i></a>
                            ...
                            <li>
                                <div class="portfolio-item">
                                    <img src="/fame-template/images/portfolio/img5.jpg" class="img-responsive" alt="" />
                                    <div class="portfolio-caption">
                                        <h4>Portfolio Title</h4>
                                        <a href="#portfolio-modal" data-toggle="modal" class="link-1"><i class="fa fa-magic"></i></a>
                                        <a href="#" class="link-2"><i class="fa fa-link"></i></a>
                            ...
                            <li>
                                <div class="portfolio-item">
                                    <img src="/fame-template/images/portfolio/img6.jpg" class="img-responsive" alt="" />
                                    <div class="portfolio-caption">
                                        <h4>Portfolio Title</h4>
                                        <a href="#portfolio-modal" data-toggle="modal" class="link-1"><i class="fa fa-magic"></i></a>
                                        <a href="#" class="link-2"><i class="fa fa-link"></i></a>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="welcome-section text-center">
                        <img src="/fame-template/images/about-01.jpg" class="img-responsive" alt="..">
                ...
                <div class="col-md-4">
                    <div class="welcome-section text-center">
                        <img src="/fame-template/images/about-02.jpg" class="img-responsive" alt="..">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div id="carousel-example-generic" class="carousel slide about-slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img src="/fame-template/images/about-01.jpg" alt="">
                            </div>
                            <div class="item">
                                <img src="/fame-template/images/about-02.jpg" alt="">
                            </div>
                            <div class="item">
                                <img src="/fame-template/images/about-03.jpg" alt="">
                            </div>
                    ...
                    <div id="team-section">
                                ...
                                <div class="our-team">
                                    ...
                                    <div class="team-member">
                                        <img src="/fame-template/images/team/manage-1.png" class="img-responsive" alt="">
                                    ...
                                    <div class="team-member">
                                        <img src="/fame-template/images/team/manage-2.png" class="img-responsive" alt="">
                                        <div class="team-details">
                                            <h4>John Doe</h4>
                                            <p>Founder & Director</p>
                                            <ul>
                                    ...
                                    <div class="team-member">
                                        <img src="/fame-template/images/team/manage-3.png" class="img-responsive" alt="">
                                        <div class="team-details">
                                            <h4>John Doe</h4>
                                            <p>Founder & Director</p>
                                            <ul>
                                    ...
                                    <div class="team-member">
                                        <img src="/fame-template/images/team/manage-4.png" class="img-responsive" alt="">
                                        <div class="team-details">
                                            <h4>John Doe</h4>
                                            <p>Founder & Director</p>
                                            <ul>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="latest-news">
                    ...
                    <div class="col-md-12">
                        <div class="latest-post">
                            <img src="/fame-template/images/about-03.jpg" class="img-responsive" alt="">
                            <h4><a href="#">Standard Post with Image</a></h4>
                            <div class="post-details">
            ...
            <div id="testimonial-carousel" class="testimonials-carousel">
                ...
                <div class="testimonials item">
                    <div class="testimonial-content">
                        <img src="/fame-template/images/testimonial/face_1.png" alt="" >
                ...
                <div class="testimonials item">
                    <div class="testimonial-content">
                        <img src="/fame-template/images/testimonial/face_2.png" alt="" >
                        <div class="testimonial-author">
                ...
                <div class="testimonials item">
                    <div class="testimonial-content">
                        <img src="/fame-template/images/testimonial/face_3.png" alt="" >
                        <div class="testimonial-author">
                            <div class="author">John Doe</div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="clients">
                    ...
                    <div class="col-md-12">
                        <img src="/fame-template/images/logos/themeforest.jpg" class="img-responsive" alt="...">
                    </div>
                    
                    <div class="col-md-12">
                        <img src="/fame-template/images/logos/creative-market.jpg" class="img-responsive" alt="...">
                    </div>
                    
                    <div class="col-md-12">
                        <img src="/fame-template/images/logos/designmodo.jpg" class="img-responsive" alt="...">
                    </div>
                    ...
                    <div class="col-md-12">
                        <img src="/fame-template/images/logos/microlancer.jpg" class="img-responsive" alt="...">
                    </div>
    ...
    <script src="/fame-template/js/jquery-2.1.1.min.js"></script>

    <!-- Bootstrap Core JavaScript -->
    <script src="/fame-template/asset/js/bootstrap.min.js"></script>

    <!-- Plugin JavaScript -->
    <script src="/fame-template/js/jquery.easing.1.3.js"></script>
    <script src="/fame-template/js/classie.js"></script>
    <script src="/fame-template/js/count-to.js"></script>
    <script src="/fame-template/js/jquery.appear.js"></script>
    <script src="/fame-template/js/cbpAnimatedHeader.js"></script>
    <script src="/fame-template/js/owl.carousel.min.js"></script>
	<script src="/fame-template/js/jquery.fitvids.js"></script>
	<script src="/fame-template/js/styleswitcher.js"></script>

    <!-- Contact Form JavaScript -->
    <script src="/fame-template/js/jqBootstrapValidation.js"></script>
    <script src="/fame-template/js/contact_me.js"></script>

    <!-- Custom Theme JavaScript -->
    <script src="/fame-template/js/script.js"></script>
