...
<head>
  ...
  <!-- Bootstrap CSS -->
  <link rel="stylesheet" href="/basic-free/css/bootstrap.min.css">
  <link rel="stylesheet" href="/basic-free/css/font-awesome.min.css">
  <link rel="stylesheet" href="/basic-free/css/simple-line-icons.css">
  <link rel="stylesheet" href="/basic-free/css/owl.carousel.css">
  <link rel="stylesheet" href="/basic-free/css/owl.theme.css">
  <link rel="stylesheet" href="/basic-free/css/animate.css">
  <link rel="stylesheet" href="/basic-free/css/main.css">
  <link rel="stylesheet" href="/basic-free/css/responsive.css">
</head>
<body>
  ...
  <header id="hero-area">    
   ...
   <nav class="navbar navbar-toggleable-sm fixed-top navbar-light bg-faded">
    <div class="container">
      <a class="navbar-brand" href="index.html"><img src="/engage/assets/img/uem-logo-40x40.png" alt=""></a>          
    ...
    <div class="row">
      <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="single-team wow fadeInLeft" data-wow-duration="1000ms" data-wow-delay="400ms">
          <img src="/basic-free/img/team/1.png" alt="">
      ...
      <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="single-team wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="500ms">
          <img src="/basic-free/img/team/2.png" alt="">
          <div class="team-content">
      ...
      <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="single-team wow fadeInRight" data-wow-duration="1000ms" data-wow-delay="400ms">
          <img src="/basic-free//basic-free/img/team/3.png" alt="">
          <div class="team-content">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="widget">
            ...
            <ul class="featured-list">
              <li>
                <a href="#"><img alt="" src="/basic-free/img/featured/img1.jpg"></a>
              </li>
              <li>
                <a href="#"><img alt="" src="/basic-free/img/featured/img2.jpg"></a>
              </li>
              <li>
                <a href="#"><img alt="" src="/basic-free/img/featured/img3.jpg"></a>
              </li>
              <li>
                <a href="#"><img alt="" src="/basic-free/img/featured/img4.jpg"></a>
              </li>
              <li>
                <a href="#"><img alt="" src="/basic-free/img/featured/img5.jpg"></a>
              </li>
              <li>
                <a href="#"><img alt="" src="/basic-free/img/featured/img6.jpg"></a>
              </li>
              <li>
                <a href="#"><img alt="" src="/basic-free/img/featured/img7.jpg"></a>
              </li>
              <li>
                <a href="#"><img alt="" src="/basic-free/img/featured/img8.jpg"></a>
              </li>
            </ul>             
          </div>
        </div>
...
<script src="/basic-free/js/jquery-min.js"></script>
<script src="/basic-free/js/tether.min.js"></script>
<script src="/basic-free/js/bootstrap.min.js"></script>
<script src="/basic-free/js/mixitup.min.js"></script>
<script src="/basic-free/js/owl.carousel.min.js"></script>    
<script src="/basic-free/js/jquery.nav.js"></script>    
<script src="/basic-free/js/smooth-scroll.js"></script>    
<script src="/basic-free/js/smooth-on-scroll.js"></script>    
<script src="/basic-free/js/wow.js"></script>    
<script src="/basic-free/js/jquery.counterup.min.js"></script>    
<script src="/basic-free/js/waypoints.min.js"></script>    
<script src="/basic-free/js/form-validator.min.js"></script>
<script src="/basic-free/js/contact-form-script.js"></script> 
<script src="/basic-free/js/main.js"></script>
</body>
</html>